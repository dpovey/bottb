...
| #   | Change                                              | Files                                                                                                                                                                              |
| --- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.1 | `git rm` accidentally tracked artifacts             | `tsconfig.tsbuildinfo`, `bottb@0.1.0`, `audio.html`, `lighthouse-report.{json,report.html,report.json}`, `SCROLL_DEBUG_INFO.md`, `.cursor/debug.log`                               |
| 1.2 | Move or gitignore root screenshots                  | 11 PNGs at repo root → `doc/screenshots/` or `.gitignore`                                                                                                                          |
| 1.3 | Reconcile orphan `docs/` against tracked `doc/`     | Merge `docs/ANALYTICS_TRACKING_PLAN.md`, `docs/SLIDESHOW_REQUIREMENTS.md`, `docs/org/` into `doc/` or delete                                                                       |
| 1.4 | Delete superseded planning docs                     | `DESIGN-TODO.md` (all ✅), pick one of `TESTING_PLAN.md`/`TESTING_SUMMARY.md`                                                                                                      |
| 1.5 | Drop unused Jest ecosystem                          | `package.json`: remove `jest`, `jest-environment-jsdom`, `jest-fixed-jsdom`, `@types/jest`                                                                                         |
...
| 1.8 | Type missing env vars                               | `src/lib/env.ts`: add `SPOTIFY_CLIENT_ID`, `SPOTIFY_CLIENT_SECRET`, `GOOGLE_SITE_VERIFICATION`, `SOCIAL_TOKEN_ENCRYPTION_KEY`, `DATABASE_URL_UNPOOLED`, `POSTGRES_URL_NON_POOLING` |
| 1.9 | Remove `@deprecated` aliases after sweeping callers | `WinnerDisplay.company`, `HeroFocalPoint` re-export in `hero.tsx`, `FocalPointImage.srcHigh`                                                                                       |
