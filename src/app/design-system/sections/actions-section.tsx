    ...
    <div className="space-y-20">
      ...
      <section id="buttons">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Filled Buttons */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Filled (For Emphasis)</h3>
            <p className="text-text-dim text-sm mb-6">Use sparingly for primary CTAs like &quot;Vote Now&quot;.</p>
            <div className="flex flex-wrap gap-4">
          ...
          {/* Accent Buttons */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Accent (Special Occasions)</h3>
            <p className="text-text-dim text-sm mb-6">For live events, winners, very important actions.</p>
            <div className="flex flex-wrap gap-4">
          ...
          {/* Ghost Buttons */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Ghost (Minimal)</h3>
            <p className="text-text-dim text-sm mb-6">No border, just text. For secondary actions.</p>
            <div className="flex flex-wrap gap-4">
          ...
          {/* Danger Buttons */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Danger (Destructive)</h3>
            <p className="text-text-dim text-sm mb-6">For destructive actions like delete.</p>
            <div className="flex flex-wrap gap-4">
