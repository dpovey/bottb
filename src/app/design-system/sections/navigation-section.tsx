        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            ...
            <p className="text-text-dim text-sm mb-6">
              Logo left • Main nav centered • Breadcrumbs right. Chevron
              separators. Hidden on mobile (hamburger menu instead).
            </p>
            ...
            <div className="bg-bg/80 backdrop-blur-md rounded-lg border border-white/5">
              <div className="flex items-center h-14 px-4">
                ...
                <div className="hidden md:flex items-center justify-center gap-6 flex-1">
                  ...
                  <a
                    href="#"
                    className="text-xs tracking-widest uppercase text-text-muted hover:text-white transition-colors"
                  >
                    Photos
                  </a>
                  <a
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            ...
            <p className="text-text-dim text-sm mb-6">
              On the home page, breadcrumbs are not needed. The right side is
              empty or can show a mobile menu button.
            </p>
            ...
            <div className="bg-bg/80 backdrop-blur-md rounded-lg border border-white/5">
              <div className="flex items-center h-14 px-4">
                ...
                <div className="flex items-center justify-center gap-6 flex-1">
                  ...
                  <a
                    href="#"
                    className="text-xs tracking-widest uppercase text-text-muted"
                  >
                    Photos
                  </a>
                  <a
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-text-dim">
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-2">
                      Events › Sydney Tech Battle 2025 ›{' '}
                      <span className="text-white">The Agentics</span>
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                  ...
                  <tr>
                    ...
                    <td className="py-2">
                      Home › <span className="text-white">Photos</span>
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <section id="social-icons">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">
              Hero Style (Circular Buttons)
            </h3>
            <p className="text-text-dim text-sm mb-6">
              Used in hero sections. Larger touch targets.
            </p>
          ...
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">
              Footer Style (Inline Icons)
            </h3>
            <p className="text-text-dim text-sm mb-6">
              Used in simple footers. Smaller, inline.
            </p>
      ...
      <section id="footer-components">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            ...
            <p className="text-text-dim text-sm mb-6">
              Used on: home.html, about.html — Sitemap, social links, copyright.
            </p>
                ...
                <div>
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-text-dim text-xs mt-2">
                      Where technology meets rock &apos;n&apos; roll.
                    </p>
                  </div>
                </div>
                <div>
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            ...
            <p className="text-text-dim text-sm mb-6">
              Used on: event.html, band.html, results.html, voting.html,
              photos.html
            </p>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-text-dim text-sm">
                    A community charity event supporting Youngcare
                  </span>
                </div>
                <div className="flex items-center gap-4">
