      ...
      <section id="hero-sections">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Home Hero (Centered, Full Height)</h3>
            <p className="text-text-dim text-sm mb-6">
              Used on: home page — Logo prominent, centered content, full viewport height.
            </p>
          ...
          {/* Event Hero */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Event Hero (Left-aligned, 70vh)</h3>
            <p className="text-text-dim text-sm mb-6">
              Used on: event page — Date badge, left-aligned content, background image.
            </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-text-dim text-sm">8 Bands Competing</span>
                    </div>
                    <h3 className="font-semibold text-2xl mb-2">Sydney Tech Battle 2025</h3>
          ...
          {/* Content Hero */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Content Hero (Left-aligned with Social)</h3>
            <p className="text-text-dim text-sm mb-6">
              Used on: about page, band page — Background image, social icons, left-aligned.
            </p>
            ...
            <div className="relative h-64 rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-text-muted text-sm mb-4">Representing Salesforce</p>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-white/10" />
                  <div className="w-8 h-8 rounded-full bg-white/10" />
                  <div className="w-8 h-8 rounded-full bg-white/10" />
                  <span className="text-text-dim text-xs ml-2">Social icons</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="page-layouts">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-bg-elevated rounded-lg p-4 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">HomeLayout</h3>
            ...
            <p className="text-text-dim text-xs mt-3">Full-bleed hero, constrained content</p>
          </div>

          {/* Web Layout */}
          <div className="bg-bg-elevated rounded-lg p-4 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">WebLayout</h3>
            <div className="bg-bg rounded-lg overflow-hidden border border-white/5">
              {/* Mini nav */}
              <div className="h-4 bg-bg-surface border-b border-white/5" />
              {/* Content */}
            ...
            <p className="text-text-dim text-xs mt-3">Standard pages, max-w-7xl content</p>
          </div>

          {/* Admin Layout */}
          <div className="bg-bg-elevated rounded-lg p-4 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">AdminLayout</h3>
            ...
            <p className="text-text-dim text-xs mt-3">Admin banner + floating toolbar</p>
          </div>
        </div>
      </section>
      ...
      <section id="breakpoints-spacing">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Responsive Breakpoints</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left py-2 pr-4 text-text-muted font-medium">Name</th>
                    <th className="text-left py-2 pr-4 text-text-muted font-medium">Min Width</th>
                    <th className="text-left py-2 text-text-muted font-medium">Container Max</th>
                  </tr>
                </thead>
                <tbody className="text-text-dim">
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4"><code className="text-accent">sm</code></td>
                    <td className="py-2 pr-4">640px</td>
                    <td className="py-2">640px</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4"><code className="text-accent">md</code></td>
                    <td className="py-2 pr-4">768px</td>
                    <td className="py-2">768px</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4"><code className="text-accent">lg</code></td>
                    <td className="py-2 pr-4">1024px</td>
                    <td className="py-2">1024px</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4"><code className="text-accent">xl</code></td>
                    <td className="py-2 pr-4">1280px</td>
                    <td className="py-2">1280px</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4"><code className="text-accent">2xl</code></td>
          ...
          {/* Content Widths */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Content Widths</h3>
          ...
          {/* Spacing Patterns */}
          <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Spacing Patterns</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left py-2 pr-4 text-text-muted font-medium">Context</th>
                    <th className="text-left py-2 text-text-muted font-medium">Pattern</th>
                  </tr>
                </thead>
                <tbody className="text-text-dim">
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Section padding</td>
                    <td className="py-2"><code className="text-accent">py-16 sm:py-20</code></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Card padding</td>
                    <td className="py-2"><code className="text-accent">p-5 sm:p-6</code></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Element gaps</td>
                    <td className="py-2"><code className="text-accent">gap-4 sm:gap-6</code></td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Page horizontal padding</td>
                    <td className="py-2"><code className="text-accent">px-6 lg:px-8</code></td>
                  </tr>
                </tbody>
              </table>
            </div>
