...
const ADMIN_ICONS: IconInfo[] = [
  ...
  { name: "DeleteIcon", icon: DeleteIcon, hoverClass: "group-hover:text-error" },
...
const MISC_ICONS: IconInfo[] = [
  ...
  { name: "WarningIcon", icon: WarningIcon, hoverClass: "group-hover:text-warning" },
  { name: "LightningIcon", icon: LightningIcon, hoverClass: "group-hover:text-accent" },
...
function IconGrid({ icons, columns = "grid-cols-3 sm:grid-cols-6" }: { icons: IconInfo[]; columns?: string }) {
  return (
    <div className={`grid ${columns} gap-4`}>
      {icons.map(({ name, icon: Icon, hoverClass }) => (
        ...
        >
          <Icon className={`w-6 h-6 text-text-muted ${hoverClass || "group-hover:text-white"} transition-colors`} />
          <span className="text-[10px] text-text-dim text-center">{name.replace("Icon", "")}</span>
        </div>
      ))}
    </div>
  );
      ...
      <section id="icon-gallery">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">React Component API</h3>
...
<SearchIcon stroke="red" strokeWidth={3} className="hover:text-white" />`}</code>
          ...
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Social Platform Icons</h3>
            <p className="text-text-dim text-sm mb-6">
              Brand icons for social media platforms. Uses <code className="text-accent">fill=&quot;currentColor&quot;</code>.
            </p>
          ...
          {/* UI Action Icons */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">UI Action Icons</h3>
            <p className="text-text-dim text-sm mb-6">
              Common UI actions and navigation. Uses <code className="text-accent">stroke=&quot;currentColor&quot;</code>.
            </p>
            <IconGrid icons={UI_ICONS} columns="grid-cols-4 sm:grid-cols-6 lg:grid-cols-10" />
          </div>

          {/* Admin/Dashboard Icons */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Admin/Dashboard Icons</h3>
            <p className="text-text-dim text-sm mb-6">Icons for admin interfaces and dashboards.</p>
            <IconGrid icons={ADMIN_ICONS} columns="grid-cols-3 sm:grid-cols-6 lg:grid-cols-9" />
          </div>

          {/* Misc Icons */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Misc Icons</h3>
            <p className="text-text-dim text-sm mb-6">Miscellaneous icons for various use cases.</p>
            <IconGrid icons={MISC_ICONS} columns="grid-cols-4 sm:grid-cols-6 lg:grid-cols-10" />
          </div>

          {/* File Structure */}
          <div className="bg-bg-elevated rounded-xl p-6 border border-white/5">
            <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">File Structure</h3>
            <pre className="bg-bg rounded-lg p-4 text-sm overflow-x-auto">
...
└── misc/              # Misc icons (Email, Building, Heart, etc.)`}</code>
      ...
      <section id="icon-sizes">
        ...
        <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
          <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Size Examples</h3>
      ...
      <section id="icon-colors">
        ...
        <div className="bg-bg-elevated rounded-lg p-6 border border-white/5">
          <h3 className="text-xs tracking-widest uppercase text-text-muted mb-4">Color Variants</h3>
