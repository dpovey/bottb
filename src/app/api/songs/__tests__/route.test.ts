  ...
  describe('GET', () => {
    ...
    it('filters songs by event', async () => {
      ...
      const request = new NextRequest(
        new URL('http://localhost/api/songs?event=event-1')
      )
      const response = await GET(request)
    ...
    it('filters songs by song type', async () => {
      ...
      const request = new NextRequest(
        new URL('http://localhost/api/songs?type=mashup')
      )
      const response = await GET(request)
    ...
    it('filters songs by search term', async () => {
      ...
      const request = new NextRequest(
        new URL('http://localhost/api/songs?search=Africa')
      )
      const response = await GET(request)
    ...
    it('supports pagination', async () => {
      ...
      const request = new NextRequest(
        new URL('http://localhost/api/songs?page=2&limit=2')
      )
      const response = await GET(request)
    ...
    it('validates song type parameter', async () => {
      const request = new NextRequest(
        new URL('http://localhost/api/songs?type=invalid')
      )
      const response = await GET(request)
