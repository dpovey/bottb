          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <p>
                  We are based in Australia and comply with the Australian Privacy Principles (APPs) contained in the <em>Privacy Act 1988</em> (Cth). If you are accessing our services from outside Australia, please be aware that your information may be transferred to, stored, and processed in Australia.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                <h3 className="font-medium text-lg text-text mb-2">2.1 Information You Provide</h3>
                <p>We may collect personal information that you voluntarily provide when you:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Register a band for an event</li>
                  <li>Purchase tickets through third-party ticketing platforms</li>
                ...
                <h3 className="font-medium text-lg text-text mb-2 mt-6">2.2 Information Collected Automatically</h3>
                <p>When you access our website, we may automatically collect:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Device and browser information</li>
                  <li>IP address and general location data</li>
                  <li>Pages visited and interaction patterns</li>
                  <li>Device fingerprint data for vote verification (to ensure voting integrity)</li>
                </ul>

                <h3 className="font-medium text-lg text-text mb-2 mt-6">2.3 Photographs and Media</h3>
                <p>
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Organise and administer Battle of the Tech Bands events</li>
                  <li>Process band registrations and manage event participation</li>
                  ...
                  <li>Support our charitable mission in partnership with Youngcare</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-text">Service providers:</strong> Including web hosting, email services, and analytics providers</li>
                  <li><strong className="text-text">Event partners:</strong> Venues and event production companies as necessary for event delivery</li>
                  <li><strong className="text-text">Sponsors:</strong> Aggregate, anonymised data about event attendance and engagement (never personal details without consent)</li>
                  <li><strong className="text-text">Youngcare:</strong> Our charity partner, for fundraising coordination</li>
                  <li><strong className="text-text">Legal authorities:</strong> When required by law or to protect our rights</li>
                </ul>
                <p className="mt-4">
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-text">Essential cookies:</strong> Required for website functionality and voting systems</li>
                  <li><strong className="text-text">Analytics cookies:</strong> Help us understand how visitors use our website</li>
                  <li><strong className="text-text">Social media cookies:</strong> Enable sharing features and embedded content</li>
                </ul>
                <p className="mt-4">
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-text">Access:</strong> Request access to the personal information we hold about you</li>
                  <li><strong className="text-text">Correction:</strong> Request correction of inaccurate or incomplete information</li>
                  <li><strong className="text-text">Complaint:</strong> Lodge a complaint about how we handle your personal information</li>
                </ul>
                <p className="mt-4">
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <p className="mt-4 text-sm">
                  If you are not satisfied with our response to your privacy complaint, you may contact the{" "}
                  <a
