...
const SCORING_CONFIGS: Record<ScoringVersion, ScoringConfig> = {
  ...
  '2025.1': {
    ...
    description:
      'Song (20) + Performance (30) + Crowd Vibe (30) + Crowd Vote (10) + Scream-o-Meter (10)',
  },
  '2026.1': {
    version: '2026.1',
    totalPoints: 100,
 ...
 */
export function parseScoringVersion(
  eventInfo?: { scoring_version?: string } | null
): ScoringVersion {
...
export function getEventWinnerInfo(
  eventInfo?: {
