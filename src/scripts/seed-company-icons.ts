...
const COMPANY_LOGOS: Record<string, { 
  ...
  "atlassian": {
    ...
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/4/4d/Atlassian-logo.svg",
    source: "WikiMedia Commons", 
  ...
  "pagerduty": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/2/22/PagerDuty_logo.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "datadog": {
  ...
  "netflix": {
    ...
    iconUrl: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Netflix_2015_N_logo.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "spotify": {
  ...
  "dropbox": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/c/cb/Dropbox_logo_2017.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "zendesk": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/c/c8/Zendesk_logo.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "hubspot": {
  ...
  "workday": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/8/80/Workday_logo.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "splunk": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/e/e8/Splunk-Logo.jpg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "cloudflare": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/9/94/Cloudflare_Logo.png",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "mongodb": {
  ...
  "redis": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/6/64/Logo-redis.svg",
    source: "WikiMedia Commons",
    license: "BSD",
  },
  "elastic": {
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/f/f4/Elasticsearch_logo.svg",
    source: "WikiMedia Commons",
    license: "Public domain",
  },
  "docker": {
...
async function fetchAndUploadLogo(
  ...
  try {
    ...
    if (!response.ok) {
      console.log(`  ⚠️ Failed to fetch: ${response.status} ${response.statusText}`);
      return null;
    }
    ...
    if (url.endsWith(".svg") || contentType.includes("svg")) {
      extension = "svg";
    } else if (url.endsWith(".jpg") || url.endsWith(".jpeg") || contentType.includes("jpeg")) {
      extension = "jpg";
    }
...
async function seedCompanyIcons() {
  ...
  try {
    ...
    for (const company of companies) {
      ...
      const logoKey = COMPANY_NAME_MAPPINGS[company.slug.toLowerCase()] ||
      ...
      if (!logoUrl) {
        logoUrl = await fetchAndUploadLogo(logoSource.logoUrl, company.slug, "logo");
      } else {
