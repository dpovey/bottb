...
async function addVisualsColumn() {
  try {
    ...
    console.log("📝 The votes table now supports the 2026.1 scoring with visuals");
    console.log("   - visuals: Integer 0-20 (judge scoring for costumes, backdrops, visual presentation)");
  } catch (error) {
