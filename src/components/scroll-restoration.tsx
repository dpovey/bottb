...
export function ScrollRestoration() {
  ...
  const originalScrollIntoView = useRef<typeof Element.prototype.scrollIntoView | null>(null);
  ...
  useEffect(() => {
    ...
    window.scrollTo = function (
      ...
      if (isInitialLoad.current && !hasHash && !userIsScrolling.current) {
        ...
        if (typeof xOrOptions === "number" && xOrOptions === 0 && (y === undefined || y === 0)) {
    ...
    const userInputEvents = ["wheel", "touchstart", "touchmove", "mousedown", "keydown"];
